...
export default {
	styles: `
		#room-profile-head { display: inline-grid; grid-template-columns: auto min-content; align-items: center; grid-gap: 5px; }
		#room-profile-name { font-size: 18pt; font-weight: 100; line-height: 110%; margin: 0; padding-left: 45px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100%; }
		#room-profile-status { font-size: 8pt; margin: 0; text-transform: uppercase; opacity: 0.5; grid-column: 1 / -1; }
